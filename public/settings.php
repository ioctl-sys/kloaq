        ...
        <div class="layout">
            <main style="max-width: 700px;">
                ...
                <div class="settings-box">
                    ...
                    <p><strong>Member since:</strong> <?= htmlspecialchars($account['created_at'] ?? 'Unknown') ?></p>
                </div>
                ...
                <div class="settings-box">
                    ...
                    <div style="display: flex; gap: 40px; margin: 20px 0;">
                        <div>
                            ...
                            <div style="color: #787c7e; font-size: 0.9rem;">Posts</div>
                        </div>
                        <div>
                            <div class="stat"><?= $stats['comments'] ?></div>
                            <div style="color: #787c7e; font-size: 0.9rem;">Comments</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="settings-box" style="background: #f8f9fa;">
                    ...
                    <p><strong>Account (Persistent):</strong></p>
                    <ul style="margin: 8px 0 16px 20px; color: #787c7e; font-size: 0.9rem;">
                    ...
                    <p><strong>Content (Ephemeral - RAM only):</strong></p>
                    <ul style="margin: 8px 0 16px 20px; color: #787c7e; font-size: 0.9rem;">
                    ...
                    <ul style="margin: 8px 0 0 20px; color: #787c7e; font-size: 0.9rem;">
                        <li>IP addresses</li>
